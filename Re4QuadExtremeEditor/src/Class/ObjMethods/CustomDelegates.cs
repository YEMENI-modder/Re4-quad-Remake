...
namespace Re4QuadExtremeEditor.src.Class.CustomDelegates
{
    ...
    public delegate ushort ReturnUshortFromPosition(ushort ID, byte FromPosition);
    public delegate void SetUshortFromPosition(ushort ID, byte FromPosition, ushort value);
