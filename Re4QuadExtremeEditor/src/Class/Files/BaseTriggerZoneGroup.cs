...
{
    /// <summary>
    /// implementação universal da TriggerZone (usada por FSE, SAR, EAR);
    /// offsets confirmados a partir da versão NewAge oficial.
    /// </summary>
    public abstract class BaseTriggerZoneGroup : BaseGroup
    {
        /// <summary>
        /// inicio da TriggerZone na line (FSE = 0x14 ; SAR/EAR = 0x04)
        /// </summary>
        ...
        protected Vector3 GetTriggerZonePos_ToCamera(ushort ID)
        {
            ...
            for (int i = 1; i <= 3; i++)
            {
                if (TriggerZone[i].X < Xmin) { Xmin = TriggerZone[i].X; }
                if (TriggerZone[i].Y < Zmin) { Zmin = TriggerZone[i].Y; }
                if (TriggerZone[i].X > Xmax) { Xmax = TriggerZone[i].X; }
                if (TriggerZone[i].Y > Zmax) { Zmax = TriggerZone[i].Y; }
            }
        ...
        #region TriggerZone (real byte offsets, confirmed from NewAge reference)
        ...
        // TriggerZone Return uint (raw hex)
        ...
        // float wrappers (used by property grid / general logic)
        protected float ReturnTriggerZoneTrueY(ushort ID) => BitConverter.ToSingle(BitConverter.GetBytes(ReturnTriggerZoneTrueY_Hex(ID)), 0);
        protected void SetTriggerZoneTrueY(ushort ID, float value) => SetTriggerZoneTrueY_Hex(ID, BitConverter.ToUInt32(BitConverter.GetBytes(value), 0));

        protected float ReturnTriggerZoneMoreHeight(ushort ID) => BitConverter.ToSingle(BitConverter.GetBytes(ReturnTriggerZoneMoreHeight_Hex(ID)), 0);
        protected void SetTriggerZoneMoreHeight(ushort ID, float value) => SetTriggerZoneMoreHeight_Hex(ID, BitConverter.ToUInt32(BitConverter.GetBytes(value), 0));

        protected float ReturnTriggerZoneCircleRadius(ushort ID) => BitConverter.ToSingle(BitConverter.GetBytes(ReturnTriggerZoneCircleRadius_Hex(ID)), 0);
        protected void SetTriggerZoneCircleRadius(ushort ID, float value) => SetTriggerZoneCircleRadius_Hex(ID, BitConverter.ToUInt32(BitConverter.GetBytes(value), 0));

        protected float ReturnTriggerZoneCorner0_X(ushort ID) => BitConverter.ToSingle(BitConverter.GetBytes(ReturnTriggerZoneCorner0_X_Hex(ID)), 0);
        protected void SetTriggerZoneCorner0_X(ushort ID, float value) => SetTriggerZoneCorner0_X_Hex(ID, BitConverter.ToUInt32(BitConverter.GetBytes(value), 0));

        protected float ReturnTriggerZoneCorner0_Z(ushort ID) => BitConverter.ToSingle(BitConverter.GetBytes(ReturnTriggerZoneCorner0_Z_Hex(ID)), 0);
        protected void SetTriggerZoneCorner0_Z(ushort ID, float value) => SetTriggerZoneCorner0_Z_Hex(ID, BitConverter.ToUInt32(BitConverter.GetBytes(value), 0));

        protected float ReturnTriggerZoneCorner1_X(ushort ID) => BitConverter.ToSingle(BitConverter.GetBytes(ReturnTriggerZoneCorner1_X_Hex(ID)), 0);
        protected void SetTriggerZoneCorner1_X(ushort ID, float value) => SetTriggerZoneCorner1_X_Hex(ID, BitConverter.ToUInt32(BitConverter.GetBytes(value), 0));

        protected float ReturnTriggerZoneCorner1_Z(ushort ID) => BitConverter.ToSingle(BitConverter.GetBytes(ReturnTriggerZoneCorner1_Z_Hex(ID)), 0);
        protected void SetTriggerZoneCorner1_Z(ushort ID, float value) => SetTriggerZoneCorner1_Z_Hex(ID, BitConverter.ToUInt32(BitConverter.GetBytes(value), 0));

        protected float ReturnTriggerZoneCorner2_X(ushort ID) => BitConverter.ToSingle(BitConverter.GetBytes(ReturnTriggerZoneCorner2_X_Hex(ID)), 0);
        protected void SetTriggerZoneCorner2_X(ushort ID, float value) => SetTriggerZoneCorner2_X_Hex(ID, BitConverter.ToUInt32(BitConverter.GetBytes(value), 0));

        protected float ReturnTriggerZoneCorner2_Z(ushort ID) => BitConverter.ToSingle(BitConverter.GetBytes(ReturnTriggerZoneCorner2_Z_Hex(ID)), 0);
        protected void SetTriggerZoneCorner2_Z(ushort ID, float value) => SetTriggerZoneCorner2_Z_Hex(ID, BitConverter.ToUInt32(BitConverter.GetBytes(value), 0));

        protected float ReturnTriggerZoneCorner3_X(ushort ID) => BitConverter.ToSingle(BitConverter.GetBytes(ReturnTriggerZoneCorner3_X_Hex(ID)), 0);
        protected void SetTriggerZoneCorner3_X(ushort ID, float value) => SetTriggerZoneCorner3_X_Hex(ID, BitConverter.ToUInt32(BitConverter.GetBytes(value), 0));

        protected float ReturnTriggerZoneCorner3_Z(ushort ID) => BitConverter.ToSingle(BitConverter.GetBytes(ReturnTriggerZoneCorner3_Z_Hex(ID)), 0);
        protected void SetTriggerZoneCorner3_Z(ushort ID, float value) => SetTriggerZoneCorner3_Z_Hex(ID, BitConverter.ToUInt32(BitConverter.GetBytes(value), 0));
        ...
        /// <summary>
        /// [0] x=Corner0.x, y=TrueY, z=Corner0.z
        /// [1] x=Corner1.x, y=MoreHeight, z=Corner1.z
        /// [2] x=Corner2.x, y=CircleRadius, z=Corner2.z
        /// [3] x=Corner3.x, y=MoreHeight+TrueY, z=Corner3.z
        /// </summary>
        ...
        /// <summary>
        /// [0..3] = 4 corners (X,Z) ; [4] = X:TrueY, Y:TrueY+MoreHeight
        /// </summary>
        ...
        /// <summary>
        /// [0] Center Point ; [1] X:TrueY, Y:TrueY+MoreHeight ; [2] X:CircleRadius, Y:0
        /// </summary>
