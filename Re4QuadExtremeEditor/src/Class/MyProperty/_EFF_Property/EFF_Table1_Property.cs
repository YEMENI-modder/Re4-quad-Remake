...
namespace Re4QuadExtremeEditor.src.Class.MyProperty._EFF_Property
{
    ...
    public class EFF_Table1_Property : BaseProperty, IInternalID
    {
        ...
        private NewAge_EFF_Table1Entry_Methods Methods = null;
        ...
        public EFF_Table1_Property(ushort InternalID, UpdateMethods updateMethods, NewAge_EFF_Table1Entry_Methods Methods, bool ForMultiSelection = false) : base()
        {
            PropertyConstructor(InternalID, updateMethods, Methods, ForMultiSelection);
        }

        private void PropertyConstructor(ushort InternalID, UpdateMethods updateMethods, NewAge_EFF_Table1Entry_Methods Methods, bool ForMultiSelection = false)
        {
        ...
        private const int CategoryID_EFF_Table1 = 4;
        #endregion
        ...
        [CustomCategory(aLang.EFF_Table1_Category)]
        [CustomDisplayName(aLang.EFF_Table1_CoreID_DisplayName)]
        [TypeConverter(typeof(HexNumberTypeConverter))]
        [HexNumber()]
        [DefaultValue(null)]
        [ReadOnly(false)]
        [Browsable(true)]
        [DynamicTypeDescriptor.Id(5, CategoryID_EFF_Table1)]
        public ushort PROP_CoreID
        {
            get => Methods.ReturnCoreID(InternalID);
            set
            {
                Methods.SetCoreID(InternalID, value);
                updateMethods.UpdateGL();
            }
        }
