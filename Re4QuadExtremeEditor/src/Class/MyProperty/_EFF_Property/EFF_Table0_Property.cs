...
namespace Re4QuadExtremeEditor.src.Class.MyProperty._EFF_Property
{
    ...
    public class EFF_Table0_Property : BaseProperty, IInternalID
    {
        ...
        private NewAge_EFF_Table0Entry_Methods Methods = null;
        ...
        public EFF_Table0_Property(ushort InternalID, UpdateMethods updateMethods, NewAge_EFF_Table0Entry_Methods Methods, bool ForMultiSelection = false) : base()
        {
            PropertyConstructor(InternalID, updateMethods, Methods, ForMultiSelection);
        }

        private void PropertyConstructor(ushort InternalID, UpdateMethods updateMethods, NewAge_EFF_Table0Entry_Methods Methods, bool ForMultiSelection = false)
        {
        ...
        private const int CategoryID_EFF_Table0 = 4;
        #endregion
        ...
        [CustomCategory(aLang.EFF_Table0_Category)]
        [CustomDisplayName(aLang.EFF_Table0_TextureID_DisplayName)]
        [TypeConverter(typeof(HexNumberTypeConverter))]
        [HexNumber()]
        [DefaultValue(null)]
        [ReadOnly(false)]
        [Browsable(true)]
        [DynamicTypeDescriptor.Id(5, CategoryID_EFF_Table0)]
        public ushort PROP_TextureID
        {
