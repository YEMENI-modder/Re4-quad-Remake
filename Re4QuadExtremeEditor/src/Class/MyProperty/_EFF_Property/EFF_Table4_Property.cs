...
namespace Re4QuadExtremeEditor.src.Class.MyProperty._EFF_Property
{
    ...
    public class EFF_Table4_Property : BaseProperty, IInternalID
    {
        ...
        private NewAge_EFF_Table4Entry_Methods Methods = null;
        ...
        public EFF_Table4_Property(ushort InternalID, UpdateMethods updateMethods, NewAge_EFF_Table4Entry_Methods Methods, bool ForMultiSelection = false) : base()
        {
            PropertyConstructor(InternalID, updateMethods, Methods, ForMultiSelection);
        }

        private void PropertyConstructor(ushort InternalID, UpdateMethods updateMethods, NewAge_EFF_Table4Entry_Methods Methods, bool ForMultiSelection = false)
        {
        ...
        private const int CategoryID_EFF_Table4 = 4;
        #endregion
        ...
        [CustomCategory(aLang.EFF_Table4_Category)]
        [CustomDisplayName(aLang.EFF_Table4_ModelID_DisplayName)]
        [TypeConverter(typeof(HexNumberTypeConverter))]
        [HexNumber()]
        [DefaultValue(null)]
        [ReadOnly(false)]
        [Browsable(true)]
        [DynamicTypeDescriptor.Id(5, CategoryID_EFF_Table4)]
        public ushort PROP_ModelID
        {
            get => Methods.ReturnModelID(InternalID);
            set
            {
                Methods.SetModelID(InternalID, value);
                updateMethods.UpdateGL();
            }
        }
