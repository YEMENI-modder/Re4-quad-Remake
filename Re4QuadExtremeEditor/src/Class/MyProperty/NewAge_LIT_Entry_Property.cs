...
namespace Re4QuadExtremeEditor.src.Class.MyProperty
{
    ...
    public class NewAge_LIT_Entry_Property : BaseProperty, IInternalID
    {
        ...
        #region Category Ids
        private const int CategoryID_InternalLineID = 0;
        private const int CategoryID_Order = 1;
        private const int CategoryID_LineArray = 2;
        private const int CategoryID_LIT_Light_Metadata = 3;
        private const int CategoryID_LIT_Light_Definition = 4;
        private const int CategoryID_LIT_Object_Settings = 5;
        private const int CategoryID_UnderDevelopment = 6;
        #endregion
        ...
        [Browsable(true)]
        [AllowInMultiSelect()]
        [DynamicTypeDescriptor.Id(100, CategoryID_LIT_Light_Definition)]
        ...
        [Browsable(true)]
        [AllowInMultiSelect()]
        [DynamicTypeDescriptor.Id(200, CategoryID_LIT_Light_Definition)]
        ...
        [Browsable(true)]
        [AllowInMultiSelect()]
        [DynamicTypeDescriptor.Id(300, CategoryID_LIT_Light_Definition)]
        ...
        [ReadOnly(false)]
        [Browsable(false)]
        [DynamicTypeDescriptor.Id(101, CategoryID_LIT_Light_Definition)]
        ...
        [ReadOnly(false)]
        [Browsable(false)]
        [DynamicTypeDescriptor.Id(201, CategoryID_LIT_Light_Definition)]
        ...
        [ReadOnly(false)]
        [Browsable(false)]
        [DynamicTypeDescriptor.Id(301, CategoryID_LIT_Light_Definition)]
        ...
        [Browsable(true)]
        [AllowInMultiSelect()]
        [DynamicTypeDescriptor.Id(400, CategoryID_LIT_Light_Definition)]
        ...
        [ReadOnly(false)]
        [Browsable(false)]
        [DynamicTypeDescriptor.Id(401, CategoryID_LIT_Light_Definition)]
        ...
        [Browsable(true)]
        [AllowInMultiSelect()]
        [DynamicTypeDescriptor.Id(500, CategoryID_LIT_Light_Definition)]
        ...
        [Browsable(true)]
        [AllowInMultiSelect()]
        [DynamicTypeDescriptor.Id(600, CategoryID_LIT_Light_Definition)]
        ...
        [Browsable(true)]
        [AllowInMultiSelect()]
        [DynamicTypeDescriptor.Id(700, CategoryID_LIT_Light_Definition)]
        ...
        [ReadOnly(false)]
        [Browsable(false)]
        [DynamicTypeDescriptor.Id(701, CategoryID_LIT_Light_Definition)]
        ...
        [Browsable(true)]
        [AllowInMultiSelect()]
        [DynamicTypeDescriptor.Id(0x1000, CategoryID_LIT_Object_Settings)]
        ...
        [Browsable(true)]
        [AllowInMultiSelect()]
        [DynamicTypeDescriptor.Id(0x1100, CategoryID_LIT_Object_Settings)]
        ...
        [Browsable(true)]
        [AllowInMultiSelect()]
        [DynamicTypeDescriptor.Id(0x1200, CategoryID_LIT_Object_Settings)]
        ...
        [Browsable(true)]
        [AllowInMultiSelect()]
        [DynamicTypeDescriptor.Id(0x1300, CategoryID_LIT_Object_Settings)]
        ...
        [Browsable(true)]
        [AllowInMultiSelect()]
        [DynamicTypeDescriptor.Id(0x1400, CategoryID_LIT_Object_Settings)]
        ...
        [Browsable(true)]
        [AllowInMultiSelect()]
        [DynamicTypeDescriptor.Id(0x1500, CategoryID_LIT_Object_Settings)]
