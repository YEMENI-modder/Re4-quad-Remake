...
// e em https://github.com/opentk/LearnOpenTK/blob/master/Common/Camera.cs
{
    public class Camera
    {
        ...
        /// <summary>
        /// Recalcula os vetores internos da câmera (front/up/right) após uma atribuição direta
        /// de Position/YawDegrees/PitchDegrees (ex: ao restaurar a câmera de um projeto salvo).
        /// Sem isso, a orientação só é recalculada no próximo movimento do mouse.
        /// </summary>
...
namespace NsCamera
{
    public interface IObject3D
    {
        OpenTK.Vector3 GetObjPosition_ToCamera();
        float GetObjAngleY_ToCamera();
    }
}
