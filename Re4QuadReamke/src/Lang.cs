   ...
   public static class Lang
    {
        ...
        public static void StartAttributeTexts()
        {
            ...
            AttributeText.Add(aLang.SpecialType06_MulitTriggerZone, "06: MulitTriggerZone");
            ...
            AttributeText.Add(aLang.ListBoxRefInteractionType03TakeIdFromESL, "Take Id from ESL");
            ...
            */
            ...
            AttributeText.Add(aLang.ESL_SpeedEnemy_Name, "Speed Enemy [Dec] (%)");
            AttributeText.Add(aLang.ESL_SpeedEnemy_Description, "Offset[0x1D][0x1C]  \r\nTAG: ESL_SpeedEnemy  \r\n\r\nEnemy movement speed as a percentage (0-999). 100 is the default speed and is stored as 0x0000; every other value is stored as-is. Only takes effect when ENABLE is 0x40 or 0x41.");
            AttributeText.Add(aLang.ESL_ScaleEnemy_Name, "Scale Enemy [Dec] (%)");
            AttributeText.Add(aLang.ESL_ScaleEnemy_Description, "Offset[0x1F][0x1E]  \r\nTAG: ESL_ScaleEnemy  \r\n\r\nEnemy size as a percentage (0-999). 100 is the default size and is stored as 0x0000; every other value is stored as-is. Only takes effect when ENABLE is 0x40 or 0x41.");
            ...
            AttributeText.Add(aLang.EFF_EffectGroup_Category, "Effect Group");
            AttributeText.Add(aLang.EFF_EffectGroup_TableOrigin_DisplayName, "Table Origin");
            AttributeText.Add(aLang.EFF_EffectGroup_EntryCountInGroup_DisplayName, "Entry Count In Group");
            AttributeText.Add(aLang.EFF_EffectGroup_Position_Category, "PositionXYZ");
            ...
            AttributeText.Add(aLang.EFF_EffectGroup_Angle_Category, "AngleXYZ");
            ...
            AttributeText.Add(aLang.EFF_Entry_Order_Category, "Order");
            AttributeText.Add(aLang.EFF_Entry_EntryOrderID_Ushort_DisplayName, "Entry Order ID");

            AttributeText.Add(aLang.EFF_Table2_Category, "EAR Links");
            AttributeText.Add(aLang.EFF_Table2_EffectGroupID_DisplayName, "Effect Group [Hex]");
            AttributeText.Add(aLang.EFF_Table2_EarLinkID_DisplayName, "EAR Link ID [Hex]");

            AttributeText.Add(aLang.EFF_Table4_Category, "BIN Model");
            AttributeText.Add(aLang.EFF_Table4_ModelID_DisplayName, "Model ID [Hex]");

            AttributeText.Add(aLang.EFF_Table0_Category, "TPL Texture");
            AttributeText.Add(aLang.EFF_Table0_TextureID_DisplayName, "Texture ID [Hex]");

            AttributeText.Add(aLang.EFF_Table1_Category, "Effect 0 Index");
            AttributeText.Add(aLang.EFF_Table1_CoreID_DisplayName, "Core ID [Hex]");

            AttributeText.Add(aLang.EFF_Table3_Category, "Effect Path");
            AttributeText.Add(aLang.EFF_Table3_PathID_DisplayName, "Path ID [Hex]");

            AttributeText.Add(aLang.EFF_Table6_Category, "Texture Data");
            AttributeText.Add(aLang.EFF_Table6_TextureHeight_DisplayName, "Texture Height");
            AttributeText.Add(aLang.EFF_Table6_TextureWidth_DisplayName, "Texture Width");
            AttributeText.Add(aLang.EFF_Table6_EffectHeight_DisplayName, "Effect Height");
            AttributeText.Add(aLang.EFF_Table6_EffectWidth_DisplayName, "Effect Width");
            AttributeText.Add(aLang.EFF_Table6_TextureCount_DisplayName, "Effect Texture Count");
            AttributeText.Add(aLang.EFF_Table6_Unknown1_DisplayName, "Offset[10]");
            AttributeText.Add(aLang.EFF_Table6_Unknown2_DisplayName, "Offset[11]");

            AttributeText.Add(aLang.EFF_EffectEntry_Category, "Effect Entry");
            AttributeText.Add(aLang.EFF_EffectEntry_GroupOrderID_DisplayName, "Group Order ID");
            AttributeText.Add(aLang.EFF_EffectEntry_TableID_DisplayName, "Table Origin (7 or 8)");
            AttributeText.Add(aLang.EFF_EffectEntry_Position_Category, "PositionXYZ");
            ...
            AttributeText.Add(aLang.EFF_EffectEntry_Angle_Category, "AngleXYZ");
            ...
            AttributeText.Add(aLang.EFF_Table9_Category, "Table 9");
            AttributeText.Add(aLang.EFF_Table9_GroupOrderID_DisplayName, "Group Order ID");
            AttributeText.Add(aLang.EFF_Table9_Position_Category, "PositionXYZ");
            ...
            AttributeText.Add(aLang.EFF_EffectEntry_Basic_Category, "Basic Info");
            AttributeText.Add(aLang.EFF_EffectEntry_StateID_DisplayName, "State I D");
            AttributeText.Add(aLang.EFF_EffectEntry_EspID_DisplayName, "Esp I D");
            AttributeText.Add(aLang.EFF_EffectEntry_TextureID_DisplayName, "Texture I D");
            AttributeText.Add(aLang.EFF_EffectEntry_Time_DisplayName, "Time");
            AttributeText.Add(aLang.EFF_EffectEntry_Parent_DisplayName, "Parent");
            AttributeText.Add(aLang.EFF_EffectEntry_Part_DisplayName, "Part");
            AttributeText.Add(aLang.EFF_EffectEntry_Flags_DisplayName, "Flags");
            AttributeText.Add(aLang.EFF_EffectEntry_Random_Category, "Random Position");
            AttributeText.Add(aLang.EFF_EffectEntry_RandomX_DisplayName, "Random X");
            AttributeText.Add(aLang.EFF_EffectEntry_RandomY_DisplayName, "Random Y");
            AttributeText.Add(aLang.EFF_EffectEntry_RandomZ_DisplayName, "Random Z");
            AttributeText.Add(aLang.EFF_EffectEntry_Speed_Category, "Speed");
            AttributeText.Add(aLang.EFF_EffectEntry_SpeedX_DisplayName, "Speed X");
            AttributeText.Add(aLang.EFF_EffectEntry_SpeedY_DisplayName, "Speed Y");
            AttributeText.Add(aLang.EFF_EffectEntry_SpeedZ_DisplayName, "Speed Z");
            AttributeText.Add(aLang.EFF_EffectEntry_DeltaSpeed_DisplayName, "Delta Speed");
            AttributeText.Add(aLang.EFF_EffectEntry_RandomSpeed_Category, "Random Speed");
            AttributeText.Add(aLang.EFF_EffectEntry_RandomSpeedX_DisplayName, "Random Speed X");
            AttributeText.Add(aLang.EFF_EffectEntry_RandomSpeedY_DisplayName, "Random Speed Y");
            AttributeText.Add(aLang.EFF_EffectEntry_RandomSpeedZ_DisplayName, "Random Speed Z");
            AttributeText.Add(aLang.EFF_EffectEntry_Acceleration_Category, "Acceleration");
            AttributeText.Add(aLang.EFF_EffectEntry_AccelerationX_DisplayName, "Acceleration X");
            AttributeText.Add(aLang.EFF_EffectEntry_AccelerationY_DisplayName, "Acceleration Y");
            AttributeText.Add(aLang.EFF_EffectEntry_AccelerationZ_DisplayName, "Acceleration Z");
            AttributeText.Add(aLang.EFF_EffectEntry_RandomAcceleration_Category, "Random Acceleration");
            AttributeText.Add(aLang.EFF_EffectEntry_RandomAccelerationX_DisplayName, "Random Acceleration X");
            AttributeText.Add(aLang.EFF_EffectEntry_RandomAccelerationY_DisplayName, "Random Acceleration Y");
            AttributeText.Add(aLang.EFF_EffectEntry_RandomAccelerationZ_DisplayName, "Random Acceleration Z");
            AttributeText.Add(aLang.EFF_EffectEntry_RandomRotation_Category, "Random Rotation");
            AttributeText.Add(aLang.EFF_EffectEntry_RandomRotationX_DisplayName, "Random Rotation X");
            AttributeText.Add(aLang.EFF_EffectEntry_RandomRotationY_DisplayName, "Random Rotation Y");
            AttributeText.Add(aLang.EFF_EffectEntry_RandomRotationZ_DisplayName, "Random Rotation Z");
            AttributeText.Add(aLang.EFF_EffectEntry_RotationAcceleration_Category, "Rotation Acceleration");
            AttributeText.Add(aLang.EFF_EffectEntry_RotationAccelerationX_DisplayName, "Rotation Acceleration X");
            AttributeText.Add(aLang.EFF_EffectEntry_RotationAccelerationY_DisplayName, "Rotation Acceleration Y");
            AttributeText.Add(aLang.EFF_EffectEntry_RotationAccelerationZ_DisplayName, "Rotation Acceleration Z");
            AttributeText.Add(aLang.EFF_EffectEntry_RandomRotationAcceleration_Category, "Random Rotation Acceleration");
            AttributeText.Add(aLang.EFF_EffectEntry_RandomRotationAccelerationX_DisplayName, "Random Rotation Acceleration X");
            AttributeText.Add(aLang.EFF_EffectEntry_RandomRotationAccelerationY_DisplayName, "Random Rotation Acceleration Y");
            AttributeText.Add(aLang.EFF_EffectEntry_RandomRotationAccelerationZ_DisplayName, "Random Rotation Acceleration Z");
            AttributeText.Add(aLang.EFF_EffectEntry_Size_Category, "Size");
            AttributeText.Add(aLang.EFF_EffectEntry_Width_DisplayName, "Width");
            AttributeText.Add(aLang.EFF_EffectEntry_Height_DisplayName, "Height");
            AttributeText.Add(aLang.EFF_EffectEntry_RandomSize_DisplayName, "Random Size");
            AttributeText.Add(aLang.EFF_EffectEntry_Grow_DisplayName, "Grow");
            AttributeText.Add(aLang.EFF_EffectEntry_DeltaGrow_DisplayName, "Delta Grow");
            AttributeText.Add(aLang.EFF_EffectEntry_Color_Category, "Color");
            AttributeText.Add(aLang.EFF_EffectEntry_ColorR_DisplayName, "Color R");
            AttributeText.Add(aLang.EFF_EffectEntry_ColorG_DisplayName, "Color G");
            AttributeText.Add(aLang.EFF_EffectEntry_ColorB_DisplayName, "Color B");
            AttributeText.Add(aLang.EFF_EffectEntry_ColorA_DisplayName, "Color A");
            AttributeText.Add(aLang.EFF_EffectEntry_DeltaColorR_DisplayName, "Delta Color R");
            AttributeText.Add(aLang.EFF_EffectEntry_DeltaColorG_DisplayName, "Delta Color G");
            AttributeText.Add(aLang.EFF_EffectEntry_DeltaColorB_DisplayName, "Delta Color B");
            AttributeText.Add(aLang.EFF_EffectEntry_DeltaColorA_DisplayName, "Delta Color A");
            AttributeText.Add(aLang.EFF_EffectEntry_DeltaColorAttack_DisplayName, "Delta Color Attack");
            AttributeText.Add(aLang.EFF_EffectEntry_DeltaColorStartFrame_DisplayName, "Delta Color Start Frame");
            AttributeText.Add(aLang.EFF_EffectEntry_Timing_Category, "Timing");
            AttributeText.Add(aLang.EFF_EffectEntry_DeltaSizeStartFrame_DisplayName, "Delta Size Start Frame");
            AttributeText.Add(aLang.EFF_EffectEntry_LifeTime_DisplayName, "Life Time");
            AttributeText.Add(aLang.EFF_EffectEntry_AnimationSpeed_DisplayName, "Animation Speed");
            AttributeText.Add(aLang.EFF_EffectEntry_ReleaseTime_DisplayName, "Release Time");
            AttributeText.Add(aLang.EFF_EffectEntry_Blend_DisplayName, "Blend");
            AttributeText.Add(aLang.EFF_EffectEntry_Simulation_Category, "Simulation");
            AttributeText.Add(aLang.EFF_EffectEntry_SimulationType_DisplayName, "Simulation Type");
            AttributeText.Add(aLang.EFF_EffectEntry_SimulationPower_DisplayName, "Simulation Power");
            AttributeText.Add(aLang.EFF_EffectEntry_MaskTextureID_DisplayName, "Mask Texture I D");
            AttributeText.Add(aLang.EFF_EffectEntry_ValueIn_DisplayName, "Value In");
            AttributeText.Add(aLang.EFF_EffectEntry_ValueOut_DisplayName, "Value Out");
            AttributeText.Add(aLang.EFF_EffectEntry_Work_Category, "Work (Unknown)");
            AttributeText.Add(aLang.EFF_EffectEntry_Work0_DisplayName, "Work0");
            AttributeText.Add(aLang.EFF_EffectEntry_Work1_DisplayName, "Work1");
            AttributeText.Add(aLang.EFF_EffectEntry_Work2_DisplayName, "Work2");
            AttributeText.Add(aLang.EFF_EffectEntry_Work3_DisplayName, "Work3");
            AttributeText.Add(aLang.EFF_EffectEntry_Work4_DisplayName, "Work4");
            AttributeText.Add(aLang.EFF_EffectEntry_Work5_DisplayName, "Work5");
            AttributeText.Add(aLang.EFF_EffectEntry_Work6_DisplayName, "Work6");
            AttributeText.Add(aLang.EFF_EffectEntry_Vector_Category, "Vectors (Unknown)");
            AttributeText.Add(aLang.EFF_EffectEntry_Vector0X_DisplayName, "Vector0 X");
            AttributeText.Add(aLang.EFF_EffectEntry_Vector0Y_DisplayName, "Vector0 Y");
            AttributeText.Add(aLang.EFF_EffectEntry_Vector0Z_DisplayName, "Vector0 Z");
            AttributeText.Add(aLang.EFF_EffectEntry_Vector1X_DisplayName, "Vector1 X");
            AttributeText.Add(aLang.EFF_EffectEntry_Vector1Y_DisplayName, "Vector1 Y");
            AttributeText.Add(aLang.EFF_EffectEntry_Vector1Z_DisplayName, "Vector1 Z");
            AttributeText.Add(aLang.EFF_EffectEntry_Vector2X_DisplayName, "Vector2 X");
            AttributeText.Add(aLang.EFF_EffectEntry_Vector2Y_DisplayName, "Vector2 Y");
            AttributeText.Add(aLang.EFF_EffectEntry_Vector2Z_DisplayName, "Vector2 Z");
            AttributeText.Add(aLang.EFF_EffectEntry_Spline_Category, "Spline (Unknown)");
            AttributeText.Add(aLang.EFF_EffectEntry_Spline0_DisplayName, "Spline0");
            AttributeText.Add(aLang.EFF_EffectEntry_Spline1_DisplayName, "Spline1");
            AttributeText.Add(aLang.EFF_EffectEntry_Spline2_DisplayName, "Spline2");
            AttributeText.Add(aLang.EFF_EffectEntry_Spline3_DisplayName, "Spline3");
            AttributeText.Add(aLang.EFF_EffectEntry_Path_Category, "Path");
            AttributeText.Add(aLang.EFF_EffectEntry_PathOwn_DisplayName, "Path Own");
            AttributeText.Add(aLang.EFF_EffectEntry_PathNumber_DisplayName, "Path Number");
            AttributeText.Add(aLang.EFF_EffectEntry_PathStart_DisplayName, "Path Start");
            AttributeText.Add(aLang.EFF_EffectEntry_PathRandom_DisplayName, "Path Random");
            AttributeText.Add(aLang.EFF_EffectEntry_Control_Category, "Control / ESP");
            AttributeText.Add(aLang.EFF_EffectEntry_EffType_DisplayName, "Eff Type");
            AttributeText.Add(aLang.EFF_EffectEntry_ControlID_DisplayName, "Control I D");
            AttributeText.Add(aLang.EFF_EffectEntry_ControlFlag_DisplayName, "Control Flag");
            AttributeText.Add(aLang.EFF_EffectEntry_ControlInterval_DisplayName, "Control Interval");
            AttributeText.Add(aLang.EFF_EffectEntry_ControlNumber_DisplayName, "Control Number");
            AttributeText.Add(aLang.EFF_EffectEntry_ControlRP_DisplayName, "Control R P");
            AttributeText.Add(aLang.EFF_EffectEntry_ControlLife_DisplayName, "Control Life");
            AttributeText.Add(aLang.EFF_EffectEntry_ControlPath_Category, "Control Path");
            AttributeText.Add(aLang.EFF_EffectEntry_ControlPathScaleX_DisplayName, "Control Path Scale X");
            AttributeText.Add(aLang.EFF_EffectEntry_ControlPathScaleY_DisplayName, "Control Path Scale Y");
            AttributeText.Add(aLang.EFF_EffectEntry_ControlPathScaleZ_DisplayName, "Control Path Scale Z");
            AttributeText.Add(aLang.EFF_EffectEntry_ControlPathDeltaSize_DisplayName, "Control Path Delta Size");
            AttributeText.Add(aLang.EFF_EffectEntry_ControlPathDeltaSpeed_DisplayName, "Control Path Delta Speed");
            AttributeText.Add(aLang.EFF_EffectEntry_ControlPathDeltaAlpha_DisplayName, "Control Path Delta Alpha");
            AttributeText.Add(aLang.EFF_EffectEntry_ControlPathDeltaInterval_DisplayName, "Control Path Delta Interval");
            AttributeText.Add(aLang.EFF_EffectEntry_ControlPathRandomInterval_DisplayName, "Control Path Random Interval");
            AttributeText.Add(aLang.EFF_EffectEntry_ControlPathRotationX_DisplayName, "Control Path Rotation X");
            AttributeText.Add(aLang.EFF_EffectEntry_ControlPathRotationY_DisplayName, "Control Path Rotation Y");
            AttributeText.Add(aLang.EFF_EffectEntry_ControlPathFlag_DisplayName, "Control Path Flag");
        ...
        public static void StartTexts() 
        {
            ...
            Text.Add(eLang.MessageBoxSmdNotFoundTitle, "SMD file not found");
            Text.Add(eLang.MessageBoxSmdNotFoundBody, "Could not find the SMD file for this room.\n\nExpected file name:\n{0}\n\nSearched in:\n{1}");

            Text.Add(eLang.MessageBoxFormClosingTitle, "Save before exit?");
            Text.Add(eLang.MessageBoxFormClosingDialog, "Would you like to save all files before exiting?");
            ...
            Text.Add(eLang.NodeEFF_Table0, "EFFBLOB - Table 0 (TPL Textures)");
            Text.Add(eLang.NodeEFF_Table1, "EFFBLOB - Table 1 (Ref Effect 0)");
            Text.Add(eLang.NodeEFF_Table2, "EFFBLOB - Table 2 (EAR Links)");
            Text.Add(eLang.NodeEFF_Table3, "EFFBLOB - Table 3 (Effect Path)");
            Text.Add(eLang.NodeEFF_Table4, "EFFBLOB - Table 4 (BIN Model)");
            Text.Add(eLang.NodeEFF_Table6, "EFFBLOB - Table 6 (Texture Metadata)");
            Text.Add(eLang.NodeEFF_Table7, "EFFBLOB - Table 7 (Effect Type 0 Groups)");
            Text.Add(eLang.NodeEFF_Table8, "EFFBLOB - Table 8 (Effect Type 1 Groups)");
            Text.Add(eLang.NodeEFF_EffectEntry, "EFFBLOB - Effect Entries");
            Text.Add(eLang.NodeEFF_Table9, "EFFBLOB - Table 9 (Paths)");
            ...
            Text.Add(eLang.NodeLIT_Groups, "Light (LIT) Groups");
            Text.Add(eLang.NodeLIT_Entrys, "Light (LIT) Entries");
            ...
            Text.Add(eLang.AddNewDSE, "Add new DSE object");
            Text.Add(eLang.AddNewFSE, "Add new FSE object");
            Text.Add(eLang.AddNewSAR, "Add new SAR object");
            Text.Add(eLang.AddNewEAR, "Add new EAR object");
            Text.Add(eLang.AddNewEMI, "Add new EMI object");
            Text.Add(eLang.AddNewESE, "Add new ESE object");
            Text.Add(eLang.AddNewLITGroup, "Add new LIT Group object");
            Text.Add(eLang.AddNewLITEntry, "Add new LIT Entry object");
            ...
            Text.Add(eLang.DiretoryDSE, "DSE File Patch:");
            Text.Add(eLang.DiretoryFSE, "FSE File Patch:");
            Text.Add(eLang.DiretorySAR, "SAR File Patch:");
            Text.Add(eLang.DiretoryEAR, "EAR File Patch:");
            Text.Add(eLang.DiretoryEMI, "EMI File Patch:");
            Text.Add(eLang.DiretoryESE, "ESE File Patch:");
            Text.Add(eLang.DiretoryLIT, "LIT File Patch:");
            Text.Add(eLang.DiretoryEFFBLOB, "EFFBLOB File Patch:");
