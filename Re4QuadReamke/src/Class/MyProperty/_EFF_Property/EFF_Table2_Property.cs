...
namespace Re4QuadExtremeEditor.src.Class.MyProperty._EFF_Property
{
    ...
    public class EFF_Table2_Property : BaseProperty, IInternalID
    {
        ...
        private NewAge_EFF_Table2Entry_Methods Methods = null;
        ...
        public EFF_Table2_Property(ushort InternalID, UpdateMethods updateMethods, NewAge_EFF_Table2Entry_Methods Methods, bool ForMultiSelection = false) : base()
        {
            PropertyConstructor(InternalID, updateMethods, Methods, ForMultiSelection);
        }

        private void PropertyConstructor(ushort InternalID, UpdateMethods updateMethods, NewAge_EFF_Table2Entry_Methods Methods, bool ForMultiSelection = false)
        {
        ...
        private const int CategoryID_EFF_Table2 = 4;
        #endregion
        ...
        [CustomCategory(aLang.EFF_Table2_Category)]
        [CustomDisplayName(aLang.EFF_Table2_EffectGroupID_DisplayName)]
        [TypeConverter(typeof(HexNumberTypeConverter))]
        [HexNumber()]
        [DefaultValue(null)]
        [ReadOnly(false)]
        [Browsable(true)]
        [DynamicTypeDescriptor.Id(5, CategoryID_EFF_Table2)]
        public ushort PROP_EffectGroupID
        {
            get => Methods.ReturnEffectGroupID(InternalID);
            set
            {
                Methods.SetEffectGroupID(InternalID, value);
                updateMethods.UpdateGL();
            }
        }

        [CustomCategory(aLang.EFF_Table2_Category)]
        [CustomDisplayName(aLang.EFF_Table2_EarLinkID_DisplayName)]
        [TypeConverter(typeof(HexNumberTypeConverter))]
        [HexNumber()]
        [DefaultValue(null)]
        [ReadOnly(false)]
        [Browsable(true)]
        [DynamicTypeDescriptor.Id(6, CategoryID_EFF_Table2)]
        public ushort PROP_EarLinkID
        {
            get => Methods.ReturnEarLinkID(InternalID);
            set
            {
                Methods.SetEarLinkID(InternalID, value);
                updateMethods.UpdateGL();
            }
        }
