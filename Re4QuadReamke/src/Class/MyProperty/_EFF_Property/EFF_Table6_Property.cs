...
namespace Re4QuadExtremeEditor.src.Class.MyProperty._EFF_Property
{
    ...
    public class EFF_Table6_Property : BaseProperty, IInternalID
    {
        ...
        private NewAge_EFF_Table6Entry_Methods Methods = null;
        ...
        public EFF_Table6_Property(ushort InternalID, UpdateMethods updateMethods, NewAge_EFF_Table6Entry_Methods Methods, bool ForMultiSelection = false) : base()
        {
            PropertyConstructor(InternalID, updateMethods, Methods, ForMultiSelection);
        }

        private void PropertyConstructor(ushort InternalID, UpdateMethods updateMethods, NewAge_EFF_Table6Entry_Methods Methods, bool ForMultiSelection = false)
        {
        ...
        private const int CategoryID_EFF_Table6 = 4;
        #endregion
        ...
        [CustomCategory(aLang.EFF_Table6_Category)]
        [CustomDisplayName(aLang.EFF_Table6_TextureHeight_DisplayName)]
        [TypeConverter(typeof(DecNumberTypeConverter))]
        [DecNumber()]
        [DefaultValue(null)]
        [ReadOnly(false)]
        [Browsable(true)]
        [DynamicTypeDescriptor.Id(5, CategoryID_EFF_Table6)]
        public ushort PROP_TextureHeight
        {
            get => Methods.ReturnTextureHeight(InternalID);
            set
            {
                Methods.SetTextureHeight(InternalID, value);
                updateMethods.UpdateGL();
            }
        }

        [CustomCategory(aLang.EFF_Table6_Category)]
        [CustomDisplayName(aLang.EFF_Table6_TextureWidth_DisplayName)]
        [TypeConverter(typeof(DecNumberTypeConverter))]
        [DecNumber()]
        [DefaultValue(null)]
        [ReadOnly(false)]
        [Browsable(true)]
        [DynamicTypeDescriptor.Id(6, CategoryID_EFF_Table6)]
        public ushort PROP_TextureWidth
        {
            get => Methods.ReturnTextureWidth(InternalID);
            set
            {
                Methods.SetTextureWidth(InternalID, value);
                updateMethods.UpdateGL();
            }
        }

        [CustomCategory(aLang.EFF_Table6_Category)]
        [CustomDisplayName(aLang.EFF_Table6_EffectHeight_DisplayName)]
        [TypeConverter(typeof(DecNumberTypeConverter))]
        [DecNumber()]
        [DefaultValue(null)]
        [ReadOnly(false)]
        [Browsable(true)]
        [DynamicTypeDescriptor.Id(7, CategoryID_EFF_Table6)]
        public ushort PROP_EffectHeight
        {
            get => Methods.ReturnEffectHeight(InternalID);
            set
            {
                Methods.SetEffectHeight(InternalID, value);
                updateMethods.UpdateGL();
            }
        }

        [CustomCategory(aLang.EFF_Table6_Category)]
        [CustomDisplayName(aLang.EFF_Table6_EffectWidth_DisplayName)]
        [TypeConverter(typeof(DecNumberTypeConverter))]
        [DecNumber()]
        [DefaultValue(null)]
        [ReadOnly(false)]
        [Browsable(true)]
        [DynamicTypeDescriptor.Id(8, CategoryID_EFF_Table6)]
        public ushort PROP_EffectWidth
        {
            get => Methods.ReturnEffectWidth(InternalID);
            set
            {
                Methods.SetEffectWidth(InternalID, value);
                updateMethods.UpdateGL();
            }
        }

        [CustomCategory(aLang.EFF_Table6_Category)]
        [CustomDisplayName(aLang.EFF_Table6_TextureCount_DisplayName)]
        [TypeConverter(typeof(DecNumberTypeConverter))]
        [DecNumber()]
        [DefaultValue(null)]
        [ReadOnly(false)]
        [Browsable(true)]
        [DynamicTypeDescriptor.Id(9, CategoryID_EFF_Table6)]
        public ushort PROP_TextureCount
        {
            get => Methods.ReturnTextureCount(InternalID);
            set
            {
                Methods.SetTextureCount(InternalID, value);
                updateMethods.UpdateGL();
            }
        }

        [CustomCategory(aLang.EFF_Table6_Category)]
        [CustomDisplayName(aLang.EFF_Table6_Unknown1_DisplayName)]
        [TypeConverter(typeof(DecNumberTypeConverter))]
        [DecNumber()]
        [DefaultValue(null)]
        [ReadOnly(false)]
        [Browsable(true)]
        [DynamicTypeDescriptor.Id(10, CategoryID_EFF_Table6)]
        public byte PROP_Unknown1
        {
            get => Methods.ReturnUnknown1(InternalID);
            set
            {
                Methods.SetUnknown1(InternalID, value);
                updateMethods.UpdateGL();
            }
        }

        [CustomCategory(aLang.EFF_Table6_Category)]
        [CustomDisplayName(aLang.EFF_Table6_Unknown2_DisplayName)]
        [TypeConverter(typeof(DecNumberTypeConverter))]
        [DecNumber()]
        [DefaultValue(null)]
        [ReadOnly(false)]
        [Browsable(true)]
        [DynamicTypeDescriptor.Id(11, CategoryID_EFF_Table6)]
        public byte PROP_Unknown2
        {
            get => Methods.ReturnUnknown2(InternalID);
            set
            {
                Methods.SetUnknown2(InternalID, value);
                updateMethods.UpdateGL();
            }
        }
