...
namespace Re4QuadExtremeEditor.src.Class.MyProperty
{
    ...
    public class NewAge_EFF_Table9Entry_Property : BaseProperty, IInternalID
    {
        public override Type GetClassType()
        {
            return typeof(NewAge_EFF_Table9Entry_Property);
        }
        ...
        public NewAge_EFF_Table9Entry_Property(NewAge_EFF_Table9Entry_Property prop, bool ForMultiSelection = false)
        {
            NewAge_EFF_Table9Entry_PropertyConstructor(prop.InternalID, prop.updateMethods, prop.Methods, ForMultiSelection);
        }

        public NewAge_EFF_Table9Entry_Property(ushort InternalID, UpdateMethods updateMethods, NewAge_EFF_Table9Entry_Methods Methods, bool ForMultiSelection = false) : base()
        {
            NewAge_EFF_Table9Entry_PropertyConstructor(InternalID, updateMethods, Methods, ForMultiSelection);
        }

        private void NewAge_EFF_Table9Entry_PropertyConstructor(ushort InternalID, UpdateMethods updateMethods, NewAge_EFF_Table9Entry_Methods Methods, bool ForMultiSelection = false)
        {
        ...
        private const int CategoryID_EFF_Table9 = 4;
        #endregion
        ...
        [CustomDisplayName(aLang.EFF_Table9_GroupOrderID_DisplayName)]
        [DefaultValue(null)]
        [ReadOnly(true)]
        [Browsable(true)]
        ...
        [CustomCategory(aLang.EFF_Table9_Position_Category)]
